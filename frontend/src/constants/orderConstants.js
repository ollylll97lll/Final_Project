...
export const ORDER_MINE_LIST_SUCESS = 'ORDER_MINE_LIST_SUCESS';
...
export const ORDER_DELIVER_SUCCESS = 'ORDER_DELIVER_SUCESS';
export const ORDER_DELIVER_FAIL = 'ORDER_DELIVER_FAIL';
export const ORDER_DELIVER_REQUEST = 'ORDER_DELIVER_REQUEST';
export const ORDER_DELIVER_RESET = 'ORDER_DELIVER_RESET';

export const ORDER_SUMMARY_SUCCESS = 'ORDER_SUMMARY_SUCESS';
